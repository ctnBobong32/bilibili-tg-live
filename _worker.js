      ...
      roomIds.forEach(function(roomId) {
        promise = promise.then(function() {
          return getMonitorState(roomId).then(function(state) {
            ...
            var roomInfo = { roomId, isLive, title, online, area, updateTime };
            if (isLive) {
